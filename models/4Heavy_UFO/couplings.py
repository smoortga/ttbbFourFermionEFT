...
GC_1 = Coupling(name = 'GC_1',
                value = '(cQb1*complex(0,1))/1.e6',
                order = {'NP':2})

GC_2 = Coupling(name = 'GC_2',
                value = '(cQb8*complex(0,1))/1.e6',
                order = {'NP':2})

GC_3 = Coupling(name = 'GC_3',
                value = '-(cQQ1*complex(0,1))/500000.',
                order = {'NP':2})
...
GC_5 = Coupling(name = 'GC_5',
                value = '(cQQ1*complex(0,1))/250000.',
                order = {'NP':2})

GC_6 = Coupling(name = 'GC_6',
                value = '-(cQQ8*complex(0,1))/500000.',
                order = {'NP':2})
...
GC_8 = Coupling(name = 'GC_8',
                value = '(cQQ8*complex(0,1))/250000.',
                order = {'NP':2})

GC_9 = Coupling(name = 'GC_9',
                value = '(cQt1*complex(0,1))/1.e6',
                order = {'NP':2})

GC_10 = Coupling(name = 'GC_10',
                 value = '(ctb1*complex(0,1))/1.e6',
                 order = {'NP':2})

GC_11 = Coupling(name = 'GC_11',
                 value = '(ctb8*complex(0,1))/1.e6',
                 order = {'NP':2})

GC_12 = Coupling(name = 'GC_12',
                 value = '(ctt1*complex(0,1))/500000.',
                 order = {'NP':2})
